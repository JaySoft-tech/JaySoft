<template>
    <section id="hero" class="relative bg-white min-h-screen overflow-hidden">
        ...
        <div
            class="absolute inset-0 z-10 flex items-center justify-center pointer-events-none select-none mt-[500px]"
        >
            <h2
        ...
        >
            <div class="grid grid-cols-1 lg:grid-cols-2">
                <div class="max-w-lg">
                    ...
                    <p
                        class="text-2xl text-black mb-10 font-light font-unbounded"
                    >
                    ...
                    <NuxtLink
                        ...
                        class="group inline-flex items-center h-[46.8px] w-auto px-6 py-3 bg-primary text-white font-unbounded font-medium rounded-full shadow-lg transition duration-300 hover:shadow-xl hover:text-primary hover:bg-white active:bg-white active:text-primary focus-visible:bg-white focus-visible:text-primary"
                    >
                        Безкоштовна <br />
                        консультація
                        <span
                            class="ml-4 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-white text-primary transition-all duration-200 group-hover:rotate-45"
                        >
                            <img
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
                ref="counterSection"
                class="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 lg:gap-x-16 text-center"
            >
                <div>
                    ...
                    <p
                        class="mt-2 text-base text-black font-unbounded font-regular"
                    >
